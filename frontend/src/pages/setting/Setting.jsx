...
const Setting = () => {
	...
	const handleCheckbox = async (event) => {
		...
		if (event.target.checked) await axios.post("api/addSetting", { user_id: userId, name: checkedVal, type: nameVal });
		else await axios.post("api/deleteSetting", { user_id: userId, name: checkedVal, type: nameVal });
	};
